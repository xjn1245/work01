...
if __name__ == "__main__":
    # 测试模块
    domain_understanding = StudyAbroadDomainUnderstanding()
    
    test_messages = [
        "我想申请美国计算机科学硕士，GPA 3.5，托福100分，需要准备什么？",
        "英国商科硕士学费大概多少？",
        "什么时候开始准备留学申请比较合适？"
    ]
    ...
    for msg in test_messages:
        print(f"\n测试消息: {msg}")
        intent = domain_understanding.detect_intent(msg)
        info = domain_understanding.extract_key_info(msg)
        print(f"意图: {intent}")
        print(f"关键信息: {info}")